// // src/pages/Agent/UnservedTicketsModal.tsx
// import { useEffect, useState } from "react";
// import { useToast } from "../../context/toast/useToast";
// import { agentAPI } from "../../api/agentAPI";

// type UnservedTicketsModalProps = {
//   agentId: number;
//   branchId: number;
//   onClose: () => void;
...
// export default function UnservedTicketsModal({
//   agentId,
//   branchId,
//   onClose,
//   onActionComplete,
// }: UnservedTicketsModalProps) {
//   const { showToast } = useToast();
//   const [tickets, setTickets] = useState<Ticket[]>([]);
//   const [loading, setLoading] = useState(true);

//   // ✅ Fetch waiting (unserved) tickets
//   const fetchTickets = async () => {
//     try {
//       const res = await agentAPI.getWaitingTickets(agentId, branchId);
//       if (res.success) {
//         setTickets(res.data);
//       } else {
//         showToast("error", res.message || "Failed to load unserved tickets");
//       }
//     } catch {
...
//           <h2 className="text-lg font-semibold">Unserved Tickets</h2>
